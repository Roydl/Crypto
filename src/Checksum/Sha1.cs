namespace Roydl.Crypto.Checksum
{
    ...
    public sealed class Sha1 : ChecksumSample, IEquatable<Sha1>
    {
        ...
        ///     <see cref="Sha1"/> instance.
        /// </summary>
        /// <param name="other">
        ///     The <see cref="Sha1"/> instance to compare.
        /// </param>
        ...
        public override bool Equals(object other) =>
            other is Sha1 item && Equals(item);
        ...
        /// <summary>
        ///     Determines whether two specified <see cref="Sha1"/> instances have same
        ///     values.
        /// </summary>
        /// <param name="left">
        ///     The first <see cref="Sha1"/> instance to compare.
        /// </param>
        /// <param name="right">
        ///     The second <see cref="Sha1"/> instance to compare.
        /// </param>
        public static bool operator ==(Sha1 left, Sha1 right) =>
            left?.Equals(right) ?? right is null;

        /// <summary>
        ///     Determines whether two specified <see cref="Sha1"/> instances have
        ///     different values.
        /// </summary>
        /// <param name="left">
        ///     The first <see cref="Sha1"/> instance to compare.
