namespace Roydl.Crypto.Checksum
{
    ...
    public interface ICrcConfig<TValue> where TValue : struct, IComparable, IFormattable
    {
        ...
        /// <remarks>When using the <see cref="CrcOptions.Crc32.Default">CRC-32 default</see> configuration, the table is empty if SSE 4.2 is supported by the CPU.</remarks>
