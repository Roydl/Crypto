namespace Roydl.Crypto.AbstractSamples
{
    ...
    /// </summary>
    public abstract class SymmetricKeySample
    {
        private readonly byte[] _entropy, _password, _salt;
        ...
        /// <summary>
        ///     Initializes a new instance of the <see cref="SymmetricKeySample"/> class.
        /// </summary>
        /// <param name="password">
        ///     The sequence of bytes which is used as password.
        /// </param>
        ...
        /// </exception>
        protected SymmetricKeySample(byte[] password, byte[] salt, int iterations, int blockSize, int keySize)
        {
            if (password == null)
            ...
            try
            {
                ...
                _password = ProtectedData.Protect(password, _entropy, DataProtectionScope.LocalMachine);
                _salt = ProtectedData.Protect(salt, _entropy, DataProtectionScope.LocalMachine);
            }
            catch (PlatformNotSupportedException)
            {
#if DEBUG
