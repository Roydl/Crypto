...
<a href="https://github.com/Roydl/Crypto/actions"><img src="https://img.shields.io/badge/cross%E2%80%93platform-%e2%9c%94-blue?style=for-the-badge&logo=linux&logoColor=silver" title="Automatically tested with Windows 11 &amp; Ubuntu 24.04 LTS" alt="Cross-platform"></a>
...
<a href="https://github.com/Roydl/Crypto/releases"><img src="https://img.shields.io/github/v/release/Roydl/Crypto?style=for-the-badge&logo=github&logoColor=silver" title="Check the latest release" alt="Releases"></a>
...
- [Checksum Performance](#checksum-performance)
- [Usage](#usage)
  - [GetChecksum & GetCipher](#getchecksum--getcipher)
  - [HMAC Keyed-Hashing](#hmac-keyed-hashing)
  - [CRC Customization](#crc-customization)
...
| MD5 | 128-bit | [Built-in](https://learn.microsoft.com/en-us/dotnet/api/system.security.cryptography.md5?view=net-10.0) + [HMAC](https://learn.microsoft.com/en-us/dotnet/api/system.security.cryptography.hmacmd5?view=net-10.0) keyed-hash support | [Cryptographic](https://en.wikipedia.org/wiki/Cryptographic_hash_function) | _See ¹_ |
| SHA1 | 160-bit | [Built-in](https://learn.microsoft.com/en-us/dotnet/api/system.security.cryptography.sha1?view=net-10.0) + [HMAC](https://learn.microsoft.com/en-us/dotnet/api/system.security.cryptography.hmacsha1?view=net-10.0) keyed-hash support | [Cryptographic](https://en.wikipedia.org/wiki/Cryptographic_hash_function) | _See ¹_ |
...
_Especially for Adler and CRC, the performance in software mode should be much better than with any other pure C# library, but similar to libraries that work with C/C++ imports. However, I couldn't find any other library with hardware support, not even with imports._

| Algorithm | Library | Mode | Speed |
| :---- | :----: | :----: | ----: |
| Adler-32 | [**This**](https://github.com/Roydl/Crypto/blob/e47494e7509eff298905f851e21ebd51669ba5b7/src/Checksum/Adler32.cs#L216) | Software | **3028.4 MiB/s** |
| Adler-32 | [**This**](https://github.com/Roydl/Crypto/blob/e47494e7509eff298905f851e21ebd51669ba5b7/src/Checksum/Adler32.cs#L175) | Hardware (SSSE3) | **36449.9 MiB/s** |
| Adler-32 | [**This**](https://github.com/Roydl/Crypto/blob/e47494e7509eff298905f851e21ebd51669ba5b7/src/Checksum/Adler32.cs#L135) | Hardware (AVX2) | **73427.1 MiB/s** |
| CRC-32 | [Crc32.NET](https://github.com/force-net/Crc32.NET) | Software | 2334.3 MiB/s |
| CRC-32 | [**This**](https://github.com/Roydl/Crypto/blob/e47494e7509eff298905f851e21ebd51669ba5b7/src/Checksum/CrcConfig32.cs#L174) | Software | **3098.6 MiB/s** |
| CRC-32 | [**This**](https://github.com/Roydl/Crypto/blob/e47494e7509eff298905f851e21ebd51669ba5b7/src/Checksum/CrcConfig32.cs#L150) | Hardware | **12910.5 MiB/s** |
| SHA2-256 | [Built-in](https://learn.microsoft.com/en-us/dotnet/api/system.security.cryptography.sha256?view=net-10.0) | Software | 2282.7 MiB/s |
| SHA3-256 | [Built-in](https://learn.microsoft.com/en-us/dotnet/api/system.security.cryptography.sha3_256?view=net-10.0) | Software | 670.5 MiB/s |
