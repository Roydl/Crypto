namespace Roydl.Crypto.Test.ChecksumTests
{
    ...
    public class Sha3Bit512Tests
    {
        private const ChecksumAlgo Algorithm = ChecksumAlgo.Sha3Bit512;
        private const int BitWidth = 512;
        private const int HashSize = BitWidth / 4;
        private const int RawHashSize = BitWidth / 8;
        private const string ExpectedTestHash = "301bb421c971fbb7ed01dcc3a9976ce53df034022ba982b97d0f27d48c4f03883aabf7c6bc778aa7c383062f6823045a6d41b8a720afbb8a9607690f89fbe1a7";
        private const string ExpectedRangeHash = "fff59d82415f139d4a66117bedf5d30e630be6b2ac891ba1127c259599e34741340347121227f21c9aafcf9d401d499e9c924c1dd382e49b0dc435a51a336c96";
        private const string HmacExpectedTestHash = "451bd5d4b56969969839502e19eb1db8d84cf31e3cba4a3188aeda5ccd12c21d081b15c94ace4631fc94b8a9914ed185201ed6d1578029e21ba1001ee097b695";
        private const string HmacExpectedRangeHash = "29cbbf2393cc86e568589a33c2adb26523b213ee02b8163424da6ec0e263dd2a093d9f72c91dda90a0be4c4e5762b5f2f49ae7ec008144e522ba66a9ad2e6206";
        ...
        private static Sha3Bit512 _instanceDefault, _instanceStream, _instanceByteArray, _instanceString, _instanceFilePath;

        [OneTimeSetUp]
        public void CreateInstances()
        {
            _instanceDefault = new Sha3Bit512();

            using (var ms = new MemoryStream(TestVars.TestBytes))
            {
                _instanceStream = new Sha3Bit512();
                _instanceStream.ComputeHash(ms);
            }

            _instanceByteArray = new Sha3Bit512();
            _instanceByteArray.ComputeHash(TestVars.TestBytes);

            _instanceString = new Sha3Bit512();
            _instanceString.ComputeHash(TestVars.TestStr);

            File.WriteAllBytes(TestFilePath, TestVars.TestBytes);
            _instanceFilePath = new Sha3Bit512();
        ...
        {
            var instanceDefault = new Sha3Bit512();
            Assert.IsInstanceOf<Sha3Bit512>(instanceDefault);
        ...
        public void Instance_DestroySecretKey(ChecksumAlgo _)
        {
            ...
            var instance = new Sha3Bit512((byte[])secretKey.Target);
        ...
        {
            Assert.AreEqual(_instanceDefault.GetHashCode(), new Sha3Bit512().GetHashCode());
