namespace Roydl.Crypto.Test.ChecksumTests
{
    ...
    {
        private const ChecksumAlgorithm Algorithm = ChecksumAlgorithm.Sha1;
        ...
        public void CreateInstances()
        {
            ...
            _instanceByteArray = new Sha1(Vars.TestBytes);
            _instanceString = new Sha1(Vars.TestStr);
        ...
        public void InstanceCtor(int hashLength, byte[] defaultRawHash)
        {
            ...
            var instanceByteArray = new Sha1(Vars.TestBytes);
            ...
            var instanceString = new Sha1(Vars.TestStr);
