namespace Roydl.Crypto.Test.ChecksumTests
{
    ...
    public class Crc64Tests
    {
        ...
        private const int RawHashSize = 8;
        ...
        public void InstanceCtor(int hashBits, int hashSize, int rawHashSize)
        {
            ...
            var instanceFileInfo = new Crc64(new FileInfo(TestFilePath));
            Assert.IsInstanceOf(typeof(Crc64), instanceFileInfo);
        ...
        {
            Assert.AreEqual(_instanceDefault.GetHashCode(), new Crc64().GetHashCode());
