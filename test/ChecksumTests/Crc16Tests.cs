namespace Roydl.Crypto.Test.ChecksumTests
{
    ...
    public class Crc16Tests
    {
        ...
        public void InstanceCtor(int hashBits, int hashSize, int rawHashSize)
        {
            ...
            var instanceFileInfo = new Crc16(new FileInfo(TestFilePath));
            Assert.IsInstanceOf(typeof(Crc16), instanceFileInfo);
        ...
        {
            Assert.AreEqual(_instanceDefault.GetHashCode(), new Crc16().GetHashCode());
        ...
        public void InstanceOperators()
        {
            ...
            Assert.AreEqual(_instanceStream.HashNumber, (ushort)_instanceByteArray);
