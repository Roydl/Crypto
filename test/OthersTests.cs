namespace Roydl.Crypto.Test
{
    ...
    public class OthersTests
    {
        ...
        [
            ...
            new(ChecksumAlgo.Crc32Xz, ChecksumAlgo.Sha2, false, TestVarsType.TestBytes, "2bc35bcf-ed0c-65fc-cd0e-c1553d72fb54"),
            new(ChecksumAlgo.Sha2, ChecksumAlgo.Crc32Xz, false, TestVarsType.TestBytes, "cba33b6f-4d8c-c57c-ad4e-a1f59d329bd4"),
            new(ChecksumAlgo.Sha1, ChecksumAlgo.Crc64, false, TestVarsType.QuoteString, "a5a80644-f996-6528-f58f-9cea95e3569f"),
            new(ChecksumAlgo.Crc32, ChecksumAlgo.Sha2, false, TestVarsType.RangeString, "56d4e734-e845-7a3d-9103-980cd5542dec"),
            new(ChecksumAlgo.Crc32Xz, ChecksumAlgo.Sha2, true, TestVarsType.RangeString, "{c52f1114-7bd6-81cb-b190-0bf72374be7f}")
        ];
        ...
        [Test]
        [TestCase(ChecksumAlgo.Crc32, ChecksumAlgo.Sha2, TestVarsType.RangeString, "56d4e734-e845-7a3d-9103-980cd5542dec")]
        [Category("Extension")]
